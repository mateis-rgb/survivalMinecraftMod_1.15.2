...
package net.mcreator.survivalmod.block;
...
public class MossyChiseledStoneBricksBlock extends SurvivalmodModElements.ModElement {
	@ObjectHolder("survivalmod:mossy_chiseled_stone_bricks")
	public static final Block block = null;
	public MossyChiseledStoneBricksBlock(SurvivalmodModElements instance) {
		super(instance, 21);
	}
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new BlockItem(block, new Item.Properties().group(SurvivalModItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).lightValue(0));
			setRegistryName("mossy_chiseled_stone_bricks");
		}
